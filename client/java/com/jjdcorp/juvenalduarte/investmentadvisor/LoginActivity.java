...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onResume() {
        ...
        if (LoginStatusSingleton.getInstance().getStatus()) {
            Snackbar mySnackbar = Snackbar.make(findViewById(R.id.login_form), R.string.error_logged_already, Snackbar.LENGTH_LONG);
            mySnackbar.show();
            onBackPressed();
        }
    }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Integer> {
        ...
        protected Integer doInBackground(Void... params) {
            ...
            ServerLogIn servConn = new ServerLogIn(mEmail, mPassword);
            int returnCode = servConn.Authenticate();
            ...
            if (returnCode == 0) {
                ...
                logInStatus.logIn();
                logInStatus.setCredentials(servConn);
                logInStatus.setKeywords(ServerData.getInstance().getKeywords(mEmail));
        ...
        protected void onPostExecute(final Integer success) {
            ...
            if (success == 0) {
                ...
                mPasswordView.setError(getString(R.string.error_failed2contactServer));
